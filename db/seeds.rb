...
item1 = user1.items.create(category: "Night Life", lookup: "A123bx34", body: "Rooftop Bar", trip: trip1)
  ...
  comment1 = trip1.comments.create(user: user1, body: "love to party")
  comment2 = trip1.comments.create(user: user2, body: "i HATE to party")
  comment3 = trip1.comments.create(user: user2, body: "JK, I love it.")
...
item2 = user1.items.create(category: "Flight", lookup: "AA123", body: "Flight to NYC", trip: trip1)
  ...
  comment4 = trip1.comments.create(user: user1, body: "Cool Flight")
  comment5 = trip1.comments.create(user: user2, body: "I'm on that flight too")
  comment6 = trip1.comments.create(user: user2, body: "JK, I live here.")
